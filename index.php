							...
							<center>
								<?php
									if($fetch['status'] != "Done"){
										echo 
										'<a href="update_task.php?task_id='.$fetch['task_id'].'" class="btn btn-success"><i class="bi bi-check2-circle"></i></a> |';
									}
								?>
									<a href="delete_query.php?task_id=<?php echo $fetch['task_id']?>" class="btn btn-danger"><i class="bi bi-x-circle"></i></a>
							</center>
						</td>
					</tr>
					<?php
